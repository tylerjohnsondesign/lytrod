 ...
 */
namespace NF_FU_VENDOR\phpseclib3\Math\BigInteger\Engines\PHP;

use NF_FU_VENDOR\phpseclib3\Math\BigInteger\Engines\Engine;
use NF_FU_VENDOR\phpseclib3\Math\BigInteger\Engines\PHP;
use NF_FU_VENDOR\phpseclib3\Math\BigInteger\Engines\PHP\Reductions\PowerOfTwo;
/**
 * PHP Montgomery Modular Exponentiation Engine
 *
 * @author  Jim Wigginton <terrafrost@php.net>
