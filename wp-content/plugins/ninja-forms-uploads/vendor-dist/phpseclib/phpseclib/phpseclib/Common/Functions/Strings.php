 ...
 */
namespace NF_FU_VENDOR\phpseclib3\Common\Functions;

use NF_FU_VENDOR\ParagonIE\ConstantTime\Base64;
use NF_FU_VENDOR\ParagonIE\ConstantTime\Base64UrlSafe;
use NF_FU_VENDOR\ParagonIE\ConstantTime\Hex;
use NF_FU_VENDOR\phpseclib3\Math\BigInteger;
use NF_FU_VENDOR\phpseclib3\Math\Common\FiniteField;
/**
 * Common String Functions
 *
 * @author  Jim Wigginton <terrafrost@php.net>
