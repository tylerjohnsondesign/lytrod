 ...
 */
namespace NF_FU_VENDOR\phpseclib3\Crypt\EC\BaseCurves;

use NF_FU_VENDOR\phpseclib3\Common\Functions\Strings;
use NF_FU_VENDOR\phpseclib3\Math\BigInteger;
use NF_FU_VENDOR\phpseclib3\Math\Common\FiniteField\Integer;
use NF_FU_VENDOR\phpseclib3\Math\PrimeField;
use NF_FU_VENDOR\phpseclib3\Math\PrimeField\Integer as PrimeInteger;
/**
 * Curves over y^2 = x^3 + a*x + b
 *
 * @author  Jim Wigginton <terrafrost@php.net>
