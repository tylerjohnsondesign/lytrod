...
class NF_FU_Fields_Upload extends NF_Abstracts_Field {
	...
	/**
	 * Load translated settings for the field
	 * 
	 * Loads translations after init hook to ensure that the translations are available.
	 *
	 * @return void
	 */
	public function loadTranslatedSettings(): void
	{
		$translatedSettings  = NF_File_Uploads()->config('translated-field-settings');

		$this->_settings = array_merge( $this->_settings, $translatedSettings );
	}
