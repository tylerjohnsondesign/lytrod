...
class NF_FU_External_Loader {
	...
	public function register_actions( $actions ) {
		if ( $this->is_connected_services() ) {
			if( class_exists('NinjaForms\Includes\Abstracts\SotAction') && class_exists('NF_FU_External_SotAction') ){
				$actions[ 'file-upload-external' ] = new NF_FU_External_SotAction();

			} else if( class_exists('NF_FU_External_Action') ) {
