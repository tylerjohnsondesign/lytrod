...
abstract class NF_FU_External_Abstracts_Oauthservice extends NF_FU_External_Abstracts_Service {
	 ...
	 * 
	 * Abstract method that must be defined in the child
	 * @return bool
	 */
	...
	/**
	 * Return a stored access token
	 *
	 * Retrieves value stored by the TokenManager via WPOauth object.  It does
	 * not communicate with a server
	 *
	 * @return bool
	 */
