...
<header class="entry-header"></header>
 <?php 
    ...
    foreach (array($pair_one,$pair_two ) as $pair ){
        # code...
...
//    echo  ($idArray[0] !== '')?array('key'=>$key_one,'value'=>$value_one,'compare'=>'='):null,  

//if value one is NOT empty display 
...
if($idArray[0] !== ''){
    $queryName =new WP_Query(
            ...
            'relation' => 'AND',
                    ...
                    array('key'=>$key_two,'value'=>$value_two,'compare'=>'='),   
            )
        )
      );
