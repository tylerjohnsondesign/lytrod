...
<header class="entry-header"></header>
 <?php 
    ...
    $pair_four= get_query_var('ticket_four');

    $pair_five= get_query_var('ticket_five');
    ...
    $key_four = explode('-', $pair_four)[0];
    $value_four = str_replace('%20', ' ',  explode('-', $pair_four)[1]);

    $key_five = explode('-', $pair_five)[0];
    $value_five = str_replace('%20', ' ',  explode('-', $pair_five)[1]);

    $paged = ( get_query_var( 'paged' ) ) ? get_query_var( 'paged' ) : 1;

    $ticketVars = array( $key_one, $key_two, $key_three, $key_four,$key_five);
