...
$idVal = (explode('-', $pair_one)[0] == 'id')?explode('-', $pair_one)[1]:'';
...
// $ticketVars = array( $key_one ,  $key_two,$key_three );
 ...
 if($idVal!== ''){
        ...
        $queryName =new WP_Query(
            ...
            'meta_query'=> array(
            'relation' => 'AND',
                    array('key'=>$key_one,'value'=>$value_one,'compare'=>'=') ,
        ...
        <div class="ticketwrapper" id="admin-tickets-dash">
                ...
                <div class="wrapper-dash">
                        <div class="container-fluid">
                                        <div class="row">
                                                <div class="col-md-2 dash-box <?php echo ($key =='id')?' border-highlight-dash':''?> ">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="col-md-2 dash-box <?php echo ($key =='name')?' border-highlight-dash':''?> ">
                                                        <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="col-md-2 dash-box <?php echo ($key =='status')?' border-highlight-dash':''?>">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="col-md-2 dash-box <?php echo ($key =='reason')?' border-highlight-dash':''?>">
                                                                <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="col-md-2 dash-box <?php echo ($key =='serial')?'border-highlight-dash':''?>">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <i @click="clearField('serial')" v-if="serial !== '' " class="fas fa-times exit-icon "></i>
                                                                ...
                                                                <select  v-model="serial">
                                                                    <option disabled value="">Serial</option>
