...
final class NF_ConditionalLogic_FieldsCollection {
	 ...
	 */
	public function __construct( array $submitted_fields, $form_id, $is_preview = false ) {
		...
		$user_supplied_values = apply_filters(
			'ninja_forms_user_submitted_data_types',
			array(
				'value',
				'files',
			)
	...
	/**
	 * Convert the fields collection to an array.
	 *
	 * @return array
	 */
