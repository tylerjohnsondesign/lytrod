...
<div id="woo_subscriptions_empty_state">
	<div class="woo_subscriptions_empty_state__container">
		...
		<div class="woo_subscriptions_empty_state__button_container">
			<a href="<?php echo esc_url( admin_url( 'post-new.php?post_type=product' ) ); ?>" class="components-button is-secondary"><?php esc_html_e( 'Create subscription product', 'woocommerce-subscriptions' ); ?></a>
		</div>
	</div>
</div>
