...
$subscription_end_time      = $subscription->get_time( 'end', 'site' );
...
<p>
	...
	printf(
		...
		esc_html__( 'A subscription belonging to %1$s has been reactivated. Their subscription\'s details are as follows:', 'woocommerce-subscriptions' ),
...
<table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="1">
	<thead>
		<tr>
			...
			<?php if ( $subscription_end_time !== 0 ) : ?>
	...
	<tbody>
		<tr>
			...
			<?php if ( $subscription_end_time !== 0 ) : ?>
				<td class="td" style="text-align:left; vertical-align:middle;">
					<?php echo esc_html( date_i18n( wc_date_format(), $subscription_end_time ) ); ?>
				</td>
			<?php endif; ?>
		</tr>
	</tbody>
