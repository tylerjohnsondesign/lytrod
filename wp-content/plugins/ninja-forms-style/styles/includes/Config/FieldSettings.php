...
return array(
    ...
    'label_styles' => array(
        ...
        'width' => 'full',
        'selector' => '.nf-form-content .nf-field-container #nf-field-{ID}-wrap .nf-field-label label, .nf-form-content .nf-field-container #nf-field-{ID}-wrap .nf-field-label .nf-label-span'
    ),
