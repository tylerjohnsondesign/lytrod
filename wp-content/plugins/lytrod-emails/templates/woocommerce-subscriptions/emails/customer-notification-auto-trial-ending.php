<?php
/**
 * Customer notification: free trial ending, subscription will auto-renew.
 *
...
<div class="email-introduction">
    <p class="lytrod-lede">
        ...
        printf(
            ...
            esc_html__( 'Hi %1$s — your Lytrod trial ends in %2$s, on %3$s. Your license then starts automatically using your saved payment method, so there is nothing you need to do.', 'lytrod-emails' ),
