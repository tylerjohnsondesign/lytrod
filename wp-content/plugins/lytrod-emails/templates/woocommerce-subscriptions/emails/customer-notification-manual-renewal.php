...
<div class="email-introduction">
    <p class="lytrod-lede">
        ...
        printf(
            ...
            esc_html__( 'Hi %1$s — your Lytrod license is up for renewal in %2$s, on %3$s. This license does not renew automatically, so it needs a manual renewal to stay active.', 'lytrod-emails' ),
