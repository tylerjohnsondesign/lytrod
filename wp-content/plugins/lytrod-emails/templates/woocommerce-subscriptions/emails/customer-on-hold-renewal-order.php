<?php
/**
 * Customer email: on-hold renewal order.
 *
...
echo lytrod_emails_renewal_receipt( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Escaped internally.
    $order,
    __( 'Your renewal is on hold', 'lytrod-emails' ),
    __( 'We have received your license renewal and are waiting on payment to clear. A summary of your renewal is provided below.', 'lytrod-emails' )
);
...
/** This action is documented in woocommerce-subscriptions/templates/emails/customer-on-hold-renewal-order.php */
