<?php
/**
 * Customer email: completed switch order.
 *
...
echo lytrod_emails_renewal_receipt( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Escaped internally.
    $order,
    __( 'Your license plan has been updated', 'lytrod-emails' ),
    __( 'Your license change is complete. A summary of your updated license and payment details are provided below.', 'lytrod-emails' )
);
...
/** This action is documented in woocommerce-subscriptions/templates/emails/customer-completed-switch-order.php */
