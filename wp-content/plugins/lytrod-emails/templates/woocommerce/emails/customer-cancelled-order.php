...
echo lytrod_emails_intro( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Escaped internally.
    ...
    sprintf(
        ...
        __( 'Hi %s — your order has been cancelled. Nothing further is owed. The details are below for your records.', 'lytrod-emails' ),
        Lytrod_Emails_Content::first_name( $order )
    )
);

/** This action is documented in woocommerce/templates/emails/customer-cancelled-order.php */
