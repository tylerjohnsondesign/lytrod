...
let theBlocks = {
	"Basic": {
      ...
      <blockquote class="blockquote text-center">
			<p editable="inline" class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
			<footer editable="inline" class="blockquote-footer">Someone famous in <cite title="Source Title">Source Title</cite></footer>
		</blockquote>
                    `
			},
			{
		...
		blocks: [
			{
				...
				template_html: `<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" allowfullscreen="" loading="lazy" src="https://www.youtube.com/embed/zpOULjyy-n8?rel=0" title="YouTube video"></iframe></div>`
			},
			{
				name: "MP4 Video",
				icon_html: `<i aria-hidden="true" class="fa fa-youtube-play"></i>`,
				template_html: ` <video autoplay="true" class="w-100" id="video-RANDOMNUMBER" loop="" muted="" playsinline="" preload="" style="z-index:1;object-fit: cover; object-position: 50% 50%;">
                        <!-- adjust object-position to tweak cropping on mobile --><source src="https://cdn.livecanvas.com/media/nature/video.mp4" type="video/mp4"/></video><script> //////////////// interaction observer VIDEO: pauses when video is not seen if (!!window.IntersectionObserver) { let video = document.querySelector('#video-RANDOMNUMBER'); let isPaused = true; /* flag for auto-pausing of the video */ let observer = new IntersectionObserver((entries, observer) => { entries.forEach(entry => { if (entry.intersectionRatio != 1 && !video.paused) { video.pause(); isPaused = true; console.log('video-RANDOMNUMBER paused'); } else if (isPaused) { video.play(); isPaused = false; console.log('video-RANDOMNUMBER play'); } }); }, { threshold: 1 }); observer.observe(video); } //////////////////////////////////////////////////////////////////////// </script>`
			},
			{
				name: "Generic Iframe",
				icon_html: `<i aria-hidden="true" class="fa fa-code"></i>`,
				template_html: `<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" allowfullscreen="" loading="lazy" src="https://getbootstrap.com/" title=""></iframe></div>`
			},
			{
				name: "Lightbox Player",
				icon_html: `<i aria-hidden="true" class="fa fa-youtube-play"></i>`,
				template_html: `<div class="lc-block"><div class="position-relative"><img alt=" " class="img-fluid rounded shadow" height="419" width="746" src="https://images.unsplash.com/photo-1621947081720-86970823b77a?ixlib=rb-1.2.1&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=746&amp;q=80"><a class="position-absolute glightbox d-flex justify-content-center align-items-center" href="https://www.youtube.com/watch?v=BKgpLOUYZJ4" style="top:50%;left:50%;transform:translate(-50%,-50%);"><svg class="text-white" fill="currentColor" width="5em" height="5em" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" lc-helper="svg-icon"><path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM6.79 5.093A.5.5 0 0 0 6 5.5v5a.5.5 0 0 0 .79.407l3.5-2.5a.5.5 0 0 0 0-.814l-3.5-2.5z"></path></svg></a></div></div>`
			},
			{
				name: "Vimeo",
				icon_html: `<i aria-hidden="true" class="fa fa-vimeo"></i>`,
				template_html: `<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" loading="lazy" src="https://player.vimeo.com/video/183213801?color=ffffff&amp;title=0&amp;byline=0&amp;portrait=0"></iframe></div>`
			},
			{
				name: "SoundCloud",
				icon_html: `<i aria-hidden="true" class="fa fa-soundcloud"></i>`,
				template_html: `<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" loading="lazy" src="https://w.soundcloud.com/player/?visual=true&amp;url=https%3A%2F%2Fapi.soundcloud.com%2Ftracks%2F564062355&amp;show_artwork=true&amp;maxwidth=640&amp;maxheight=960&amp;dnt=1"></iframe></div>`
			},
			{
				name: "Mixcloud",
				icon_html: `<i aria-hidden="true" class="fa fa-mixcloud"></i>`,
				template_html: `<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" loading="lazy" src="https://www.mixcloud.com/widget/iframe/?feed=https%3A%2F%2Fwww.mixcloud.com%2FDJJazzyJeff%2Fsummertime-mixtape-vol-9%2F&amp;amp;hide_cover=1"></iframe></div>`
			},
			{
				name: "Google Map",
				icon_html: `<i aria-hidden="true" class="fa fa-map-marker"></i>`,
				template_html: `<div class="embed-responsive embed-responsive-16by9" lc-helper="gmap-embed"><iframe class="embed-responsive-item" loading="lazy" src="https://maps.google.com/maps?q=London%2C%20UK&amp;t=m&amp;z=8&amp;output=embed&amp;iwloc=near"></iframe></div>`
			},
		],
	},
	"Image and Text": {
		...
		blocks: [
			{
				...
				template_html: `<div class="d-flex align-items-center"><div class="flex-shrink-0"><img alt="Alt desc here" class="rounded-circle" height="96" loading="lazy" src="https://cdn.livecanvas.com/media/avatars/avatar1.jpg" width="96"/></div><div class="flex-grow-1 ml-3"><div editable="rich"><h5>Andrew J. Hoover</h5><p>Art Director</p></div></div></div>`
			},
			{
				...
				template_html: `<div class="d-flex align-items-center"><div class="flex-grow-1 mr-3 text-right"><div editable="rich"><h5>Shawn J. Amaral</h5><p>Seo Consultant</p></div></div><div class="flex-shrink-0"><img alt="Alt desc here" class="rounded-circle" height="96" loading="lazy" src="https://cdn.livecanvas.com/media/avatars/avatar2.jpg" width="96"/></div></div>`
			},
			{
				...
				template_html: `<div class="d-flex"><div class="flex-shrink-0"><img alt="Alt desc here" class="rounded" height="96" loading="lazy" src="https://cdn.livecanvas.com/media/thumbnails/img1.jpg" width="96"/></div><div class="flex-grow-1 ml-3"><div editable="rich"><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc et metus id ligula malesuada placerat sit amet quis enim. Aliquam erat volutpat.</p></div></div></div>`
			},
			{
			...
			},
			{
				...
				template_html: `<img alt="Alt desc here" class="float-left mr-2 rounded" height="96" loading="lazy" src="https://cdn.livecanvas.com/media/thumbnails/img1.jpg" width="96"/><div editable="rich"><p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc et metus id ligula malesuada placerat sit amet quis enim. Aliquam erat volutpat. In pellentesque scelerisque auctor. Ut porta lacus eget nisi fermentum lobortis. Vestibulum facilisis tempor ipsum, ut rhoncus magna ultricies laoreet. Proin vehicula erat eget libero accumsan iaculis. </p></div>`
			},
			{
				name: "Floating Right",
				...
				template_html: `<img alt="Alt desc here" class="float-right ml-2 rounded" height="96" loading="lazy" src="https://cdn.livecanvas.com/media/thumbnails/ocean1.jpg" width="96"/><div editable="rich"><p class="text-right"> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc et metus id ligula malesuada placerat sit amet quis enim. Aliquam erat volutpat. In pellentesque scelerisque auctor. Ut porta lacus eget nisi fermentum lobortis. Vestibulum facilisis tempor ipsum, ut rhoncus magna ultricies laoreet. Proin vehicula erat eget libero accumsan iaculis. </p></div>`
			},
			{
				name: "Longer Text",
			...
			},
			{
				...
				template_html: `<img alt="Photo by Marita Kavelashvili" class="img-fluid float-none float-md-right ml-3 mb-4 mb-md-0 rounded col-md-4" height="768" loading="lazy" sizes="(max-width: 1080px) 100vw, 1080px" src="https://images.unsplash.com/photo-1542273917363-3b1817f69a2d?crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8OHx8Zm9yZXN0fGVufDB8MHx8fDE2NDk5Mzg5ODc&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1080&amp;h=768" srcset="https://images.unsplash.com/photo-1542273917363-3b1817f69a2d?crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8OHx8Zm9yZXN0fGVufDB8MHx8fDE2NDk5Mzg5ODc&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1080&amp;h=768 1080w, https://images.unsplash.com/photo-1542273917363-3b1817f69a2d??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8OHx8Zm9yZXN0fGVufDB8MHx8fDE2NDk5Mzg5ODc&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=150 150w, https://images.unsplash.com/photo-1542273917363-3b1817f69a2d??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8OHx8Zm9yZXN0fGVufDB8MHx8fDE2NDk5Mzg5ODc&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=300 300w, https://images.unsplash.com/photo-1542273917363-3b1817f69a2d??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8OHx8Zm9yZXN0fGVufDB8MHx8fDE2NDk5Mzg5ODc&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=768 768w, https://images.unsplash.com/photo-1542273917363-3b1817f69a2d??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8OHx8Zm9yZXN0fGVufDB8MHx8fDE2NDk5Mzg5ODc&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1024 1024w" style="" width="1080"/><div editable="rich"><h2>The quick brown fox jumps over the lazy dog</h2><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
                        Suspendisse a lacus est. Etiam diam metus, lobortis non augue at, placerat viverra risus. Cras ornare faucibus laoreet. Aenean vel nisi in ipsum congue fermentum et ut arcu. Proin leo diam, vulputate eu tellus ac, mattis cursus nunc. In aliquet erat ac eros congue maximus. Fusce cursus leo at elit tincidunt, consequat ultrices ante pretium. Vivamus ut dapibus nisl, nec condimentum purus.</p><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse a lacus est. Etiam diam metus, lobortis non augue at, placerat viverra risus. Cras ornare faucibus laoreet. Aenean vel nisi in ipsum congue fermentum et ut arcu. Proin leo diam, vulputate eu tellus ac, mattis cursus nunc. In aliquet erat ac eros congue maximus. Fusce cursus leo at elit tincidunt, consequat ultrices ante pretium. Vivamus ut dapibus nisl, nec condimentum purus.</p><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse a lacus est. Etiam diam metus, lobortis non augue at, placerat viverra risus. Cras ornare faucibus laoreet. Aenean vel nisi in ipsum congue fermentum et ut arcu. Proin leo diam, vulputate eu tellus ac, mattis cursus nunc. In aliquet erat ac eros congue maximus. Fusce cursus leo at elit tincidunt, consequat ultrices ante pretium. Vivamus ut dapibus nisl, nec condimentum purus.</p></div>`
			},
		],
	},
  ...
  },
  {
    ...
    template_html: `<svg class="mb-3" fill="currentColor" height="3em" lc-helper="svg-icon" viewbox="0 0 16 16" width="3em" xmlns="http://www.w3.org/2000/svg"><path d="M4.002 0a4 4 0 0 0-4 4v8a4 4 0 0 0 4 4h8a4 4 0 0 0 4-4V4a4 4 0 0 0-4-4h-8zm1.06 12h3.475c1.804 0 2.888-.908 2.888-2.396 0-1.102-.761-1.916-1.904-2.034v-.1c.832-.14 1.482-.93 1.482-1.816 0-1.3-.955-2.11-2.542-2.11H5.062V12zm1.313-4.875V4.658h1.78c.973 0 1.542.457 1.542 1.237 0 .802-.604 1.23-1.764 1.23H6.375zm0 3.762h1.898c1.184 0 1.81-.48 1.81-1.377 0-.885-.65-1.348-1.886-1.348H6.375v2.725z" fill-rule="evenodd"></path></svg><div editable="rich"><p class="font-weight-bold h3">+150</p><p class="text-muted">Icons</p></div>`
  },
  {
  ...
  },
  {
	...
	"Cards": {
		...
		blocks: [
			...
			{
				name: "Right Aligned",
				template_html: `<div class="card p-1 p-md-4 mb-4 mb-lg-0" lc-helper="background" style="background:url(https://images.unsplash.com/photo-1524260855046-f743b3cdad07?ixlib=rb-1.2.1&amp;q=80&amp;fm=jpg&amp;crop=entropy&amp;cs=tinysrgb&amp;w=1080&amp;h=768&amp;fit=crop&amp;ixid=eyJhcHBfaWQiOjM3ODR9) center / cover no-repeat; background-color:#ccc; background-blend-mode: overlay;"><div class="card-body text-right"><div class="lc-block"><svg class="mb-4" fill="currentColor" height="2em" lc-helper="svg-icon" viewbox="0 0 16 16" width="2em" xmlns="http://www.w3.org/2000/svg"><path d="M4.807 5.001C4.021 6.298 3.203 7.6 2.5 8.917v.971h2.905V11h1.112V9.888h.733V8.93h-.733V5.001h-1.71zm-1.23 3.93v-.032a46.781 46.781 0 0 1 1.766-3.001h.062V8.93H3.577zm9.831-3.93h-1.306L9.835 7.687h-.057V5H8.59v6h1.187V9.075l.615-.699L12.072 11H13.5l-2.232-3.415 2.14-2.584z"></path><path d="M14 3H2a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1zM2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H2z" fill-rule="evenodd"></path></svg></div><div class="lc-block"><div editable="rich"><h3 class="h5">Card icon on top-right</h3><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc et metus id ligula malesuada placerat sit amet quis enim.</p></div></div><div class="lc-block"><a class="btn btn-sm btn-primary" href="#">Read more</a></div></div></div>`
    }
		],
	},
	"Bootstrap 4 blocks": {
		description: "Classic Bootstrap 4 components like media objects, accordions, and modals.",
		blocks: [
			{
				"name": "Blurb",
				"icon_html": "<i aria-hidden=\"true\" class=\"fa fa-vcard-o\"></i>",
				"template_html": "<!-- Start Blurb -->\n<div class=\"row py-2\">\n  <div class=\"col-3 text-center\">\n    <svg viewBox=\"0 0 16 16\" class=\"bi bi-person-circle rws-2\" fill=\"currentColor\" xmlns=\"http://www.w3.org/2000/svg\">\n      <path d=\"M13.468 12.37C12.758 11.226 11.195 10 8 10s-4.757 1.225-5.468 2.37A6.987 6.987 0 0 0 8 15a6.987 6.987 0 0 0 5.468-2.63z\"></path>\n      <path fill-rule=\"evenodd\" d=\"M8 9a3 3 0 1 0 0-6 3 3 0 0 0 0 6z\"></path>\n      <path fill-rule=\"evenodd\" d=\"M8 1a7 7 0 1 0 0 14A7 7 0 0 0 8 1zM0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8z\"></path>\n    </svg>\n  </div>\n  <div class=\"col-9\" editable=\"inline\">\n    <strong>Hello World</strong><br>\n    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc et metus id ligula malesuada placerat sit amet quis enim.\n  </div>\n</div>\n<!-- End Blurb -->"
			},
			{
				"name": "Media Object",
				"icon_html": "<i aria-hidden=\"true\" class=\"fa fa-id-card-o\"></i>",
				"template_html": "<div class=\"media\">\n  <img src=\"https://cdn.livecanvas.com/media/svg/undraw-sample/undraw_wordpress_utxt.svg\" class=\"align-self-center mr-3\" style=\"width:120px\">\n  <div class=\"media-body\">\n    <h5 class=\"mt-0\" editable=\"inline\">Center-aligned media</h5>\n    <p editable=\"inline\">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.&nbsp;</p>\n  </div>\n</div>"
			},
			{
				"name": "Alert",
				"icon_html": "<i aria-hidden=\"true\" class=\"fa fa-info-circle\"></i>",
				"template_html": "<div class=\"alert alert-primary\" role=\"alert\" editable=\"rich\">\n  A simple alert with some editable text.\n</div>"
			},
			{
				"name": "Progress Bar",
				"icon_html": "<i aria-hidden=\"true\" class=\"fa fa-minus\"></i>",
				"template_html": "<div class=\"progress\">\n  <div class=\"progress-bar progress-bar-striped progress-bar-animated\" role=\"progressbar\" aria-valuenow=\"75\" aria-valuemin=\"0\" aria-valuemax=\"100\" style=\"width: 75%\"></div>\n</div>"
			},
			{
				"name": "Button + Collapsible",
				"icon_html": "<i aria-hidden=\"true\" class=\"fa fa-plus-square\"></i>",
				"template_html": "<a class=\"btn btn-primary\" data-toggle=\"collapse\" href=\"#collapse-RANDOMID\" role=\"button\" aria-expanded=\"false\" aria-controls=\"collapse-RANDOMID\">Click me to reveal content</a>\n<div class=\"lc-block collapse\" id=\"collapse-RANDOMID\">\n  <div class=\"card card-body\" editable=\"rich\">\n    Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident.\n  </div>\n</div>"
			},
			{
				"name": "Accordion",
				"icon_html": "<i aria-hidden=\"true\" class=\"fa fa-server\"></i>",
				"template_html": "<div class=\"accordion\" id=\"accordion-RANDOMID\">\n  <div class=\"card\">\n    <div class=\"card-header\" id=\"headingOne\">\n      <h5 class=\"mb-0\">\n        <button class=\"btn btn-link\" type=\"button\" data-toggle=\"collapse\" data-target=\"#collapse-RANDOMID-1\" aria-expanded=\"true\" aria-controls=\"collapse-RANDOMID-1\"> Item #1 </button>\n      </h5>\n    </div>\n    <div id=\"collapse-RANDOMID-1\" class=\"collapse show\" aria-labelledby=\"headingOne\" data-parent=\"#accordion-RANDOMID\">\n      <div class=\"card-body lc-block\"><div editable=\"rich\"><p>Lorem ipsum dolor sit amet…</p></div></div>\n    </div>\n  </div>\n  <div class=\"card\">\n    <div class=\"card-header\" id=\"headingTwo\">\n      <h5 class=\"mb-0\">\n        <button class=\"btn btn-link collapsed\" type=\"button\" data-toggle=\"collapse\" data-target=\"#collapse-RANDOMID-2\" aria-expanded=\"false\" aria-controls=\"collapse-RANDOMID-2\"> Item #2 </button>\n      </h5>\n    </div>\n    <div id=\"collapse-RANDOMID-2\" class=\"collapse\" aria-labelledby=\"headingTwo\" data-parent=\"#accordion-RANDOMID\">\n      <div class=\"card-body lc-block\"><div editable=\"rich\"><p>Lorem ipsum dolor sit amet…</p></div></div>\n    </div>\n  </div>\n  <div class=\"card\">\n    <div class=\"card-header\" id=\"headingThree\">\n      <h5 class=\"mb-0\">\n        <button class=\"btn btn-link collapsed\" type=\"button\" data-toggle=\"collapse\" data-target=\"#collapse-RANDOMID-3\" aria-expanded=\"false\" aria-controls=\"collapse-RANDOMID-3\"> Item #3</button>\n      </h5>\n    </div>\n    <div id=\"collapse-RANDOMID-3\" class=\"collapse\" aria-labelledby=\"headingThree\" data-parent=\"#accordion-RANDOMID\">\n      <div class=\"card-body lc-block\"><div editable=\"rich\"><p>Lorem ipsum dolor sit amet…</p></div></div>\n    </div>\n  </div>\n</div>"
			},
			{
				"name": "Carousel",
				"icon_html": "<i aria-hidden=\"true\" class=\"fa fa-photo\"></i>",
				"template_html": "<div id=\"carousel-RANDOMID\" class=\"carousel slide carousel-fade\" data-ride=\"carousel\">\n  <div class=\"carousel-inner\">\n    <div class=\"carousel-caption lc-block\">\n      <h1 class=\"font-weight-bold\" style=\"font-size:5vw;\" editable=\"inline\">Any Bold Claim.</h1>\n      <p class=\"font-weight-light\" style=\"font-size:1.5vw;\" editable=\"inline\">And some more text as a subtitle or explanation of your goals.</p>\n    </div>\n    <div class=\"carousel-item active\"><img class=\"d-block w-100\" src=\"https://cdn.livecanvas.com/media/architecture/s1.jpg\" alt=\"First slide\"></div>\n    <div class=\"carousel-item\"><img class=\"d-block w-100\" src=\"https://cdn.livecanvas.com/media/architecture/s2.jpg\" alt=\"Second slide\"></div>\n    <div class=\"carousel-item\"><img class=\"d-block w-100\" src=\"https://cdn.livecanvas.com/media/architecture/s3.jpg\" alt=\"Third slide\"></div>\n  </div>\n  <a class=\"carousel-control-prev\" href=\"#carousel-RANDOMID\" role=\"button\" data-slide=\"prev\">\n    <span class=\"carousel-control-prev-icon\" aria-hidden=\"true\"></span>\n    <span class=\"sr-only\">Previous</span>\n  </a>\n  <a class=\"carousel-control-next\" href=\"#carousel-RANDOMID\" role=\"button\" data-slide=\"next\">\n    <span class=\"carousel-control-next-icon\" aria-hidden=\"true\"></span>\n    <span class=\"sr-only\">Next</span>\n  </a>\n</div>"
			},
			{
				"name": "Button + Modal Window",
				"icon_html": "<i aria-hidden=\"true\" class=\"fa fa-mouse-pointer\" style=\"font-size:2vh;\"></i> <i class=\"fa fa-window-maximize\" aria-hidden=\"true\"></i>",
				"template_html": "<!-- Button trigger modal -->\n<button type=\"button\" class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#modal-RANDOMID\">Open the modal</button>\n<!-- Modal -->\n<div class=\"modal fade\" id=\"modal-RANDOMID\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"modal-RANDOMID-Label\" aria-hidden=\"true\">\n  <div class=\"modal-dialog\" role=\"document\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <h5 class=\"modal-title\" editable=\"inline\" id=\"modal-RANDOMID-Label\">Modal title</h5>\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">×</span></button>\n      </div>\n      <div class=\"modal-body\" editable=\"rich\">Lorem ipsum dolor sit amet…</div>\n      <div class=\"modal-footer\">\n        <button type=\"button\" class=\"btn btn-primary\" data-dismiss=\"modal\">Close</button>\n      </div>\n    </div>\n  </div>\n</div>"
    }
		],
	},
	"Galleries": {
		...
		blocks: [
					...
					
			{
				...
				template_html: `
					<div class="row g-3">
						<div class="col-md-4">
							<div class="lc-block">
								<img class="img-fluid" loading="lazy" alt="Photo by Louis Endelicher" src="https://images.unsplash.com/photo-1568304785106-40da9f3706d7?crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MjN8fG1vdXRhaW58ZW58MHwwfHx8MTYzODM3NDk1OA&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1080&amp;h=768" srcset="https://images.unsplash.com/photo-1568304785106-40da9f3706d7?crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MjN8fG1vdXRhaW58ZW58MHwwfHx8MTYzODM3NDk1OA&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1080&amp;h=768 1080w, https://images.unsplash.com/photo-1568304785106-40da9f3706d7??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MjN8fG1vdXRhaW58ZW58MHwwfHx8MTYzODM3NDk1OA&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=700 700w, https://images.unsplash.com/photo-1568304785106-40da9f3706d7??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MjN8fG1vdXRhaW58ZW58MHwwfHx8MTYzODM3NDk1OA&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=300 300w, https://images.unsplash.com/photo-1568304785106-40da9f3706d7??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MjN8fG1vdXRhaW58ZW58MHwwfHx8MTYzODM3NDk1OA&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=768 768w, https://images.unsplash.com/photo-1568304785106-40da9f3706d7??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MjN8fG1vdXRhaW58ZW58MHwwfHx8MTYzODM3NDk1OA&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1024 1024w" sizes="(max-width: 1080px) 100vw, 1080px" width="1080" height="768">
							</div>
						</div>
						<div class="col-md-4">
							<div class="lc-block">
								<img class="img-fluid" loading="lazy" alt="Photo by Gaétan Meyer" src="https://images.unsplash.com/photo-1563791877320-9a7190ccd0f5?crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MTB8fG1vdXRhaW58ZW58MHwwfHx8MTYzODM3NDkzNw&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1080&amp;h=768" srcset="https://images.unsplash.com/photo-1563791877320-9a7190ccd0f5?crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MTB8fG1vdXRhaW58ZW58MHwwfHx8MTYzODM3NDkzNw&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1080&amp;h=768 1080w, https://images.unsplash.com/photo-1563791877320-9a7190ccd0f5??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MTB8fG1vdXRhaW58ZW58MHwwfHx8MTYzODM3NDkzNw&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=700 700w, https://images.unsplash.com/photo-1563791877320-9a7190ccd0f5??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MTB8fG1vdXRhaW58ZW58MHwwfHx8MTYzODM3NDkzNw&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=300 300w, https://images.unsplash.com/photo-1563791877320-9a7190ccd0f5??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MTB8fG1vdXRhaW58ZW58MHwwfHx8MTYzODM3NDkzNw&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=768 768w, https://images.unsplash.com/photo-1563791877320-9a7190ccd0f5??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MTB8fG1vdXRhaW58ZW58MHwwfHx8MTYzODM3NDkzNw&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1024 1024w" sizes="(max-width: 1080px) 100vw, 1080px" width="1080" height="768">
							</div>
						</div>
						<div class="col-md-4">
							<div class="lc-block">
								<img class="img-fluid" loading="lazy" alt="Photo by Mateus Campos Felipe" src="https://images.unsplash.com/photo-1559562591-6de6f7187f56?crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MTN8fG1vdXRhaW58ZW58MHwwfHx8MTYzODM3NDk1Mg&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1080&amp;h=768" srcset="https://images.unsplash.com/photo-1559562591-6de6f7187f56?crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MTN8fG1vdXRhaW58ZW58MHwwfHx8MTYzODM3NDk1Mg&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1080&amp;h=768 1080w, https://images.unsplash.com/photo-1559562591-6de6f7187f56??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MTN8fG1vdXRhaW58ZW58MHwwfHx8MTYzODM3NDk1Mg&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=700 700w, https://images.unsplash.com/photo-1559562591-6de6f7187f56??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MTN8fG1vdXRhaW58ZW58MHwwfHx8MTYzODM3NDk1Mg&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=300 300w, https://images.unsplash.com/photo-1559562591-6de6f7187f56??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MTN8fG1vdXRhaW58ZW58MHwwfHx8MTYzODM3NDk1Mg&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=768 768w, https://images.unsplash.com/photo-1559562591-6de6f7187f56??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MTN8fG1vdXRhaW58ZW58MHwwfHx8MTYzODM3NDk1Mg&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1024 1024w" sizes="(max-width: 1080px) 100vw, 1080px" width="1080" height="768">
							</div>
						</div>
					</div>`
			},
			{
				...
				<div class="row g-3">
					<div class="col-md-6 col-lg-6">
						<div class="lc-block">
							<img class="img-fluid" src="https://images.unsplash.com/photo-1504537103742-67c282f65f24?crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8NXx8cmVkfGVufDB8MHx8fDE2MzUwMDE3NTQ&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1080&amp;h=768" srcset="https://images.unsplash.com/photo-1504537103742-67c282f65f24?crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8NXx8cmVkfGVufDB8MHx8fDE2MzUwMDE3NTQ&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1080&amp;h=768 1080w, https://images.unsplash.com/photo-1504537103742-67c282f65f24??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8NXx8cmVkfGVufDB8MHx8fDE2MzUwMDE3NTQ&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=150 150w, https://images.unsplash.com/photo-1504537103742-67c282f65f24??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8NXx8cmVkfGVufDB8MHx8fDE2MzUwMDE3NTQ&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=300 300w, https://images.unsplash.com/photo-1504537103742-67c282f65f24??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8NXx8cmVkfGVufDB8MHx8fDE2MzUwMDE3NTQ&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=768 768w, https://images.unsplash.com/photo-1504537103742-67c282f65f24??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8NXx8cmVkfGVufDB8MHx8fDE2MzUwMDE3NTQ&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1024 1024w" sizes="(max-width: 1080px) 100vw, 1080px" width="1080" height="768" alt="Photo by Alexander Mils" loading="lazy">
						</div>
						
					</div>
					<div class="col-md-6 col-lg-6">
						<div class="lc-block">
							<img class="img-fluid" src="https://images.unsplash.com/photo-1598476543599-72c8a60894d7?crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8OXx8cmVkfGVufDB8MHx8fDE2MzUwMDE3NTQ&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1080&amp;h=768" srcset="https://images.unsplash.com/photo-1598476543599-72c8a60894d7?crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8OXx8cmVkfGVufDB8MHx8fDE2MzUwMDE3NTQ&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1080&amp;h=768 1080w, https://images.unsplash.com/photo-1598476543599-72c8a60894d7??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8OXx8cmVkfGVufDB8MHx8fDE2MzUwMDE3NTQ&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=150 150w, https://images.unsplash.com/photo-1598476543599-72c8a60894d7??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8OXx8cmVkfGVufDB8MHx8fDE2MzUwMDE3NTQ&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=300 300w, https://images.unsplash.com/photo-1598476543599-72c8a60894d7??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8OXx8cmVkfGVufDB8MHx8fDE2MzUwMDE3NTQ&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=768 768w, https://images.unsplash.com/photo-1598476543599-72c8a60894d7??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8OXx8cmVkfGVufDB8MHx8fDE2MzUwMDE3NTQ&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1024 1024w" sizes="(max-width: 1080px) 100vw, 1080px" width="1080" height="768" alt="Photo by Scott Webb" loading="lazy">
						</div>
						
					</div>
					<div class="col-md-6 col-lg-6">
						<div class="lc-block">
							<img class="img-fluid" src="https://images.unsplash.com/photo-1530128118208-89f6ce02b37b?crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MXx8cmVkfGVufDB8MHx8fDE2MzUwMDE3NTQ&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1080&amp;h=768" srcset="https://images.unsplash.com/photo-1530128118208-89f6ce02b37b?crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MXx8cmVkfGVufDB8MHx8fDE2MzUwMDE3NTQ&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1080&amp;h=768 1080w, https://images.unsplash.com/photo-1530128118208-89f6ce02b37b??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MXx8cmVkfGVufDB8MHx8fDE2MzUwMDE3NTQ&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=150 150w, https://images.unsplash.com/photo-1530128118208-89f6ce02b37b??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MXx8cmVkfGVufDB8MHx8fDE2MzUwMDE3NTQ&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=300 300w, https://images.unsplash.com/photo-1530128118208-89f6ce02b37b??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MXx8cmVkfGVufDB8MHx8fDE2MzUwMDE3NTQ&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=768 768w, https://images.unsplash.com/photo-1530128118208-89f6ce02b37b??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MXx8cmVkfGVufDB8MHx8fDE2MzUwMDE3NTQ&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1024 1024w" sizes="(max-width: 1080px) 100vw, 1080px" width="1080" height="768" alt="Photo by Ed Leszczynskl" loading="lazy">
						</div>
						
					</div>
					<div class="col-md-6 col-lg-6">
						<div class="lc-block">
							<img class="img-fluid" src="https://images.unsplash.com/photo-1575041051612-323e644ca1b8?crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MTF8fHJlZHxlbnwwfDB8fHwxNjM1MDAxNzY3&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1080&amp;h=768" srcset="https://images.unsplash.com/photo-1575041051612-323e644ca1b8?crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MTF8fHJlZHxlbnwwfDB8fHwxNjM1MDAxNzY3&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1080&amp;h=768 1080w, https://images.unsplash.com/photo-1575041051612-323e644ca1b8??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MTF8fHJlZHxlbnwwfDB8fHwxNjM1MDAxNzY3&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=150 150w, https://images.unsplash.com/photo-1575041051612-323e644ca1b8??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MTF8fHJlZHxlbnwwfDB8fHwxNjM1MDAxNzY3&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=300 300w, https://images.unsplash.com/photo-1575041051612-323e644ca1b8??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MTF8fHJlZHxlbnwwfDB8fHwxNjM1MDAxNzY3&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=768 768w, https://images.unsplash.com/photo-1575041051612-323e644ca1b8??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8MTF8fHJlZHxlbnwwfDB8fHwxNjM1MDAxNzY3&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1024 1024w" sizes="(max-width: 1080px) 100vw, 1080px" width="1080" height="768" alt="Photo by Levi Midnight" loading="lazy">
						</div>
			...
			},
			{
				...
				template_html: `
					<div class="row g-3">
						...
						<div class="col-lg-3 col-md-6">
							<div class="lc-block">
								<img class="img-fluid" loading="lazy" alt="Photo by eberhard 🖐 grossgasteiger" src="https://images.unsplash.com/photo-1532423622396-10a3f979251a?crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8NTJ8fG9jZWFufGVufDB8MHx8fDE2MzgzNzUyMjI&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1080&amp;h=768" srcset="https://images.unsplash.com/photo-1532423622396-10a3f979251a?crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8NTJ8fG9jZWFufGVufDB8MHx8fDE2MzgzNzUyMjI&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1080&amp;h=768 1080w, https://images.unsplash.com/photo-1532423622396-10a3f979251a??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8NTJ8fG9jZWFufGVufDB8MHx8fDE2MzgzNzUyMjI&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=700 700w, https://images.unsplash.com/photo-1532423622396-10a3f979251a??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8NTJ8fG9jZWFufGVufDB8MHx8fDE2MzgzNzUyMjI&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=300 300w, https://images.unsplash.com/photo-1532423622396-10a3f979251a??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8NTJ8fG9jZWFufGVufDB8MHx8fDE2MzgzNzUyMjI&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=768 768w, https://images.unsplash.com/photo-1532423622396-10a3f979251a??crop=entropy&amp;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=MnwzNzg0fDB8MXxzZWFyY2h8NTJ8fG9jZWFufGVufDB8MHx8fDE2MzgzNzUyMjI&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1024 1024w" sizes="(max-width: 1080px) 100vw, 1080px" width="1080" height="768">
							</div> 
						</div> 
					</div>`
			},
			{
				name: "Gallery with Six images",
				icon_html: `<i aria-hidden="true" class="fa fa-th-large"></i>`,
				template_html: `
					<div class="row g-3">
			...
			{
				name: "Gallery with Eight images",
				icon_html: `<i aria-hidden="true" class="fa fa-th-large"></i>`,
				template_html: `
					<div class="row g-3">
	...
	"Dynamic Post Loops": {
		...
		<!-- Carousel wrapper -->
		<div id="carouselRANDOMID" class="carousel slide" data-ride="carousel">
			...
			<a class="carousel-control-prev" href="#carouselRANDOMID" role="button" data-slide="prev">
				<span class="carousel-control-prev-icon" aria-hidden="true"></span>
				<span class="sr-only">Previous</span>
			</a>

			<!-- Carousel controls: Next button -->
			<a class="carousel-control-next" href="#carouselRANDOMID" role="button" data-slide="next">
				<span class="carousel-control-next-icon" aria-hidden="true"></span>
				<span class="sr-only">Next</span>
			</a>
		</div>
					...
					<div class="accordion small" id="accordionExample-RANDOMID">
						<loop type="post" count="6">
							<div class="card border-top rounded-0">
								<div class="card-header bg-transparent border-0 p-0" id="heading-{Field id}">
									<h2 class="mb-0">
										<button class="btn btn-link btn-block text-left font-weight-bold collapsed" type="button" data-toggle="collapse" data-target="#collapse-{Field id}" aria-expanded="false" aria-controls="collapse-{Field id}">
											<field name="title"></field>
										</button>
									</h2>
								</div>
								<div id="collapse-{Field id}" class="collapse" aria-labelledby="heading-{Field id}" data-parent="#accordionExample-RANDOMID">
					...
					<div class="accordion accordion-flush" id="accordionExample-RANDOMID">
						<loop type="post" count="6">
							<div class="card border-0 border-bottom">
								<div class="card-header bg-transparent border-0 p-0" id="heading-{Field id}">
									<h2 class="mb-0">
										<button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#flush-collapse-{Field id}" aria-expanded="false" aria-controls="flush-collapse-{Field id}">
											<field name="title"></field>
										</button>
									</h2>
								</div>
								<div id="flush-collapse-{Field id}" class="collapse" aria-labelledby="heading-{Field id}" data-parent="#accordionExample-RANDOMID">
									<div class="card-body">
										<field name="content"></field>
									</div>
								</div>
			...
			},
			{
				...
				template_html: `<tangible class="live-refresh">
					<div class="accordion" id="accordion-RANDOMID">
						<loop order="desc" orderby="date" paged="6" type="post">
							<if first="">
								<!-- FIRST ACCORDION ITEM: OPEN -->
								<div class="card border-0 border-bottom">
									<div class="card-header bg-transparent border-0 p-0" id="heading-{Get loop=count}">
										<h2 class="mb-0">
											<button class="btn btn-link btn-block text-left font-weight-bold" type="button" data-toggle="collapse" data-target="#RANDOMID-collapse-{Get loop=count}" aria-expanded="true" aria-controls="RANDOMID-collapse-{Get loop=count}">
												<field name="title"></field>
											</button>
										</h2>
									</div>
									<div id="RANDOMID-collapse-{Get loop=count}" class="collapse show" aria-labelledby="heading-{Get loop=count}" data-parent="#accordion-RANDOMID">
										<div class="card-body">
											<field name="content"></field>
										</div>
									</div>
								...
								<else>
									...
									<div class="card border-0 border-bottom">
										<div class="card-header bg-transparent border-0 p-0" id="heading-{Get loop=count}">
											<h2 class="mb-0">
												<button class="btn btn-link btn-block text-left font-weight-bold collapsed" type="button" data-toggle="collapse" data-target="#RANDOMID-collapse-{Get loop=count}" aria-expanded="false" aria-controls="RANDOMID-collapse-{Get loop=count}">
													<field name="title"></field>
												</button>
											</h2>
										</div>
										<div id="RANDOMID-collapse-{Get loop=count}" class="collapse" aria-labelledby="heading-{Get loop=count}" data-parent="#accordion-RANDOMID">
											<div class="card-body">
												<field name="content"></field>
											</div>
										</div>
...

			{
				...
				template_html: `
					<tangible class="live-refresh">
						<loop order="desc" orderby="date" paged="6" type="post">
							<div class="row align-items-start py-4 border-top">
								<div class="col-lg-3 mb-3 mb-lg-0">
									<span class="text-muted text-uppercase font-weight-bold small d-block">
										<field name="publish_date" date_format="F j, Y"></field>
									</span>
								</div>
								<div class="col-lg-9">
									<div class="border-left pl-4 position-relative">
										<span class="d-none d-lg-inline-block bg-primary rounded-circle position-absolute" style="width:12px;height:12px;left:-6px;top:4px;"></span>
										<h3 class="font-weight-bold mb-2">
											<a href="{Field url}" class="text-dark">
												<field title=""></field>
											</a>
										</h3>
										<div class="mb-3">
											<field excerpt="" length="15" auto="true"></field>
										</div>
										<a class="font-weight-bold" href="{Field url}">Read more &gt;&gt;</a>
									</div>
								</div>
							</div>
						</loop>
				...
				<tangible class="live-refresh">
						<nav>
							<div class="nav nav-tabs" id="nav-tab" role="tablist">
								<loop type="post" count="6">
									<a aria-controls="RANDOMID-nav-area-{Field id}" aria-selected="{If first}true{Else}false{/If}" class="nav-link {If first}active{/If}" data-toggle="tab" href="#RANDOMID-nav-area-{Field id}" id="RANDOMID-nav-area-{Field id}-tab" role="tab">
										<field name="title"></field>
									</a>
								</loop>
							</div>
						...
						<div class="tab-content" id="nav-tabContent">
							<loop type="post" count="6">
								<div aria-labelledby="RANDOMID-nav-area-{Field id}-tab" class="tab-pane fade {If first}show active{/If}" id="RANDOMID-nav-area-{Field id}" role="tabpanel">
									<div class="lc-block">
										<div editable="rich">
											<h2>
												<field name="title"></field>
					...
					<nav class="navbar navbar-expand-lg navbar-light bg-light">
						<div class="container-fluid">
							...
							<div class="collapse navbar-collapse" id="myNavbar1">
								<div lc-helper="shortcode" class="live-shortcode mr-auto">[lc_nav_menu theme_location="primary" container_class="" container_id="" menu_class="navbar-nav"]</div>
							</div>
						</div>
					</nav>
				`
	...
	"ACF": {
		...
		blocks: [
			...
			},
			{
				...
				"template_html": `<tangible class='live-refresh'>
					<!-- Bootstrap 4 Carousel from ACF Gallery field "my_gallery_field" -->
					<div id='acfGalleryCarousel-RANDOMID' class='carousel slide' data-ride='carousel'>
						<!-- Slides -->
						<div class='carousel-inner'>
						...
						<!-- Controls -->
						<a class='carousel-control-prev' href='#acfGalleryCarousel-RANDOMID' role='button' data-slide='prev'>
							<span class='carousel-control-prev-icon' aria-hidden='true'></span>
							<span class='sr-only'>Previous</span>
						</a>
						<a class='carousel-control-next' href='#acfGalleryCarousel-RANDOMID' role='button' data-slide='next'>
							<span class='carousel-control-next-icon' aria-hidden='true'></span>
							<span class='sr-only'>Next</span>
						</a>
					</div>
			...
			},
			{
				...
				"template_html": `
						<tangible class="live-refresh"> <!-- This code calls the repeater field 'faq' and displays subfields 'question' and 'answer' --> <!-- Adjust code and fields to fit your needs --> 
						<div class="accordion accordion-RANDOMID" id="accordion-RANDOMID">
							<loop acf_repeater="faq">
								...
								<div class="card border-0 border-bottom">
									<div class="card-header bg-transparent border-0 p-0" id="heading-{Get loop=count}">
										<h2 class="mb-0">
											<button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#RANDOMID-collapse-{Get loop=count}" aria-expanded="false" aria-controls="RANDOMID-collapse-{Get loop=count}">
												<field name="question">
												</field>
											</button>
										</h2>
	...
	"WooCommerce Integration": {
		description: "WooCommerce shortcodes for product grids, filters, and cart interactions.",
		blocks: [
			{
				name: "Products",
	...
	"WordPress Templating": {
		description: "Template helpers for WordPress posts, fields, loops, and metadata.",
		blocks: [
			{
				name: "Post Title",
				icon_html: `<i aria-hidden="true" class="fa fa-wordpress"></i>`,
	...
	"WooCommerce Templating": {
		description: "Template helpers for WooCommerce product data and catalog elements.",
		blocks: [
			{
				name: "Product Title",
				icon_html: `<i aria-hidden="true" class="fa fa-header"></i>`,
