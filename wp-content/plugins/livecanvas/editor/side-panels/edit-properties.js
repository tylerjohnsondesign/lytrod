...
////////////////// INTERFACE BUILDING /////////////////////////////
//still to be finished and used, just an idea
/*
...
$(document).ready(function ($) {
    ...
    */
    ...
    $("body").on("change", "#sidepanel section *[attribute-name]", function () {
        ...
        myConsoleLog("Attribute values editing > attribute_name: " + attribute_name); // esce "paged"


        //UNIQUE ID CHECK
        if (attribute_name === "ID" && !!doc.getElementById(attribute_value)) {
        ...
        if (attribute_name === 'html') {
            setPageHTML(selector + " " + inner_selector, attribute_value);
        } else {
            myConsoleLog("Apply Change: Set " + selector + " the " + attribute_name + "to value:" + attribute_value);
            setAttributeValue(selector + " " + inner_selector, attribute_name, attribute_value);
        }

        //TANGIBLE LOOP PREVIEW FIX: USE PARENT SELECTOR
        if (selector.includes("loop")) {
            myConsoleLog("Loop edited!");
    ...
    */
    ...
    ////////  AOS ANIMATIONS: ON INPUT CHANGE, CHECK AOS IS LOADED
